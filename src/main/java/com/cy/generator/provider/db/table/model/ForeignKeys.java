...
import com.cy.generator.provider.db.table.model.ForeignKey;
import com.cy.generator.provider.db.table.model.Table;
import com.cy.generator.util.ListHashtable;
...
public class ForeignKeys  implements java.io.Serializable{
	...
	protected com.cy.generator.provider.db.table.model.Table parentTable;  //宿主表
	protected ListHashtable associatedTables;
	/**
	 * Constructor for Foreign Keys
	 */
	public ForeignKeys(com.cy.generator.provider.db.table.model.Table aTable) {
		super();
		parentTable      = aTable;
	...
	public void addForeignKey(String tableName, String columnName,  String parentColumn, Integer seq) {
		com.cy.generator.provider.db.table.model.ForeignKey tbl = null;
		if (associatedTables.containsKey(tableName)) {
			tbl = (com.cy.generator.provider.db.table.model.ForeignKey) associatedTables.get(tableName);
		}
		else {
			tbl = new com.cy.generator.provider.db.table.model.ForeignKey(parentTable,tableName);
	...
	public boolean getHasImportedKeyColumn(String aColumn) {
		...
		for (int i=0;i<numKeys;i++) {
			com.cy.generator.provider.db.table.model.ForeignKey aKey = (com.cy.generator.provider.db.table.model.ForeignKey) getAssociatedTables().getOrderedValue(i);
	...
	public com.cy.generator.provider.db.table.model.ForeignKey getAssociatedTable(String name) {
		Object fkey = getAssociatedTables().get(name);
		if (fkey != null) {
			return (com.cy.generator.provider.db.table.model.ForeignKey) fkey;
		}
		else return null;
	}
	/**
	...
	public com.cy.generator.provider.db.table.model.ForeignKey getImportedKeyParentColumn(String aColumn) {
		com.cy.generator.provider.db.table.model.ForeignKey aKey = null;
		int numKeys = getAssociatedTables().size();
		for (int i=0;i<numKeys;i++) {
