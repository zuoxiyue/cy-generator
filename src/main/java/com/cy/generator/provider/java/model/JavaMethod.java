...
import com.cy.generator.provider.java.model.JavaField;
import com.cy.generator.provider.java.model.MethodParameter;
import com.cy.generator.provider.java.model.MethodParameter.JavaSourceFileMethodParametersParser;
import com.cy.generator.util.GLogger;
import com.cy.generator.util.StringHelper;
import com.cy.generator.util.typemapping.JavaImport;
...
public class JavaMethod {
	Method method;
	private com.cy.generator.provider.java.model.JavaClass clazz; //与method相关联的class
	
	
	public JavaMethod(Method method, com.cy.generator.provider.java.model.JavaClass clazz) {
		super();
	...
	public com.cy.generator.provider.java.model.JavaClass getClazz() {
		return clazz;
	}
	...
	public com.cy.generator.provider.java.model.JavaClass getReturnType() {
		return new com.cy.generator.provider.java.model.JavaClass(method.getReturnType());
	}
    ...
    public List<com.cy.generator.provider.java.model.JavaClass> getExceptionTypes() {
        List<com.cy.generator.provider.java.model.JavaClass> result = new ArrayList();
        for(Class c : method.getExceptionTypes()) {
            result.add(new com.cy.generator.provider.java.model.JavaClass(c));
        }
        return result;
    }
	...
	public Set<com.cy.generator.provider.java.model.JavaClass> getImportClasses() {
		Set<com.cy.generator.provider.java.model.JavaClass> set = new LinkedHashSet<com.cy.generator.provider.java.model.JavaClass>();
	...
	public List<MethodParameter> getParameters() {
		...
		for(int i = 0; i < parameters.length; i++) {
			results.add(new MethodParameter(i+1,this,new com.cy.generator.provider.java.model.JavaClass(parameters[i])));
		}
		return results;
	}
    ...
    public static class FieldMethodInvocation {
    	com.cy.generator.provider.java.model.JavaField field;
    	JavaMethod method;
		public FieldMethodInvocation(com.cy.generator.provider.java.model.JavaField field, JavaMethod method) {
			super();
			this.field = field;
			this.method = method;
		}
		public com.cy.generator.provider.java.model.JavaField getField() {
			return field;
		}
		public void setField(com.cy.generator.provider.java.model.JavaField field) {
			this.field = field;
		}
    ...
    public static class JavaMethodInvokeSequencesParser {
    	...
    	private com.cy.generator.provider.java.model.JavaClass clazz;
