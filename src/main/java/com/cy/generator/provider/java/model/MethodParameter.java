...
import com.cy.generator.util.paranamer.JavaSourceParanamer;
...
public class MethodParameter {
	...
	com.cy.generator.provider.java.model.JavaClass paramClass; //parameter的类型
	com.cy.generator.provider.java.model.JavaMethod method; //与parameter相关联的method
	
	public MethodParameter(int paramIndex, com.cy.generator.provider.java.model.JavaMethod method, com.cy.generator.provider.java.model.JavaClass paramClazz) {
		super();
		this.method = method;
    ...
    public com.cy.generator.provider.java.model.JavaMethod getMethod() {
		return method;
	}
