...
package com.cy.generator.util.sqlerrorcode;
...
import com.cy.generator.util.PatternMatchHelper;
import com.cy.generator.util.sqlerrorcode.SQLErrorCodes;

/**
 * Factory for creating {@link com.cy.generator.util.sqlerrorcode.SQLErrorCodes} based on the
...
public class SQLErrorCodesFactory {
	 ...
	 */
	private final Map<String, com.cy.generator.util.sqlerrorcode.SQLErrorCodes> errorCodesMap = new LinkedHashMap<String, com.cy.generator.util.sqlerrorcode.SQLErrorCodes>();

	/**
	 * Map to cache the SQLErrorCodes instance per DataSource.
	 */
	private final Map<DataSource, com.cy.generator.util.sqlerrorcode.SQLErrorCodes> dataSourceCache = new WeakHashMap<DataSource, com.cy.generator.util.sqlerrorcode.SQLErrorCodes>(16);
	...
	public com.cy.generator.util.sqlerrorcode.SQLErrorCodes newSQLErrorCodes(boolean useStateCodeForTranslation, String databaseProductNames, String dataIntegrityViolationCodes) {
	    com.cy.generator.util.sqlerrorcode.SQLErrorCodes r = new com.cy.generator.util.sqlerrorcode.SQLErrorCodes();
	...
	/**
	 * Return the {@link com.cy.generator.util.sqlerrorcode.SQLErrorCodes} instance for the given database.
	 ...
	 */
	public com.cy.generator.util.sqlerrorcode.SQLErrorCodes getErrorCodes(String dbName) {
		if(dbName == null) throw new IllegalArgumentException("Database product name must not be null");

		com.cy.generator.util.sqlerrorcode.SQLErrorCodes sec = this.errorCodesMap.get(dbName);
		if (sec == null) {
			for (com.cy.generator.util.sqlerrorcode.SQLErrorCodes candidate : this.errorCodesMap.values()) {
		...
		return new com.cy.generator.util.sqlerrorcode.SQLErrorCodes();
	}

	/**
	 * Return {@link com.cy.generator.util.sqlerrorcode.SQLErrorCodes} for the given {@link DataSource},
	 ...
	 * @see java.sql.DatabaseMetaData#getDatabaseProductName()
	 */
	public com.cy.generator.util.sqlerrorcode.SQLErrorCodes getErrorCodes(DataSource dataSource) {


		synchronized (this.dataSourceCache) {
			// Let's avoid looking up database product info if we can.
			com.cy.generator.util.sqlerrorcode.SQLErrorCodes sec = this.dataSourceCache.get(dataSource);
			if (sec != null) {
				return sec;
			}
