...
import com.cy.generator.util.sqlerrorcode.SQLErrorCodesFactory;
 ...
 * @see com.cy.generator.util.sqlerrorcode.SQLErrorCodesFactory
 * @see SQLStateSQLExceptionTranslator
 */
public class SQLErrorCodeSQLExceptionTranslator {

    /** Error codes used by this translator */
    private com.cy.generator.util.sqlerrorcode.SQLErrorCodes sqlErrorCodes;
     ...
     */
    public SQLErrorCodeSQLExceptionTranslator(com.cy.generator.util.sqlerrorcode.SQLErrorCodes sec) {
     ...
     * @param dataSource DataSource to use to find metadata and establish
     * which error codes are usable
     * @see com.cy.generator.util.sqlerrorcode.SQLErrorCodesFactory#getErrorCodes(DataSource)
     * @see java.sql.DatabaseMetaData#getDatabaseProductName()
     */
    public void setDataSource(DataSource dataSource) {
        this.sqlErrorCodes = com.cy.generator.util.sqlerrorcode.SQLErrorCodesFactory.getInstance().getErrorCodes(dataSource);
    }
     ...
     * to get the metadata.
     * @param dbName the database product name that identifies the error codes entry
     * @see com.cy.generator.util.sqlerrorcode.SQLErrorCodesFactory#getErrorCodes(String)
     * @see java.sql.DatabaseMetaData#getDatabaseProductName()
     */
     ...
     */
    public void setSqlErrorCodes(com.cy.generator.util.sqlerrorcode.SQLErrorCodes sec) {
        this.sqlErrorCodes = sec;
    }
