...
import com.cy.generator.util.AntPathStringMatcher;
...
public class AntPathMatcher  {
	...
	protected boolean doMatch(String pattern,
		...
		String[] pattDirs = com.cy.generator.util.StringHelper.tokenizeToStringArray(pattern, this.pathSeparator);
		String[] pathDirs = com.cy.generator.util.StringHelper.tokenizeToStringArray(path, this.pathSeparator);
	...
	public String extractPathWithinPattern(String pattern, String path) {
		String[] patternParts = com.cy.generator.util.StringHelper.tokenizeToStringArray(pattern, this.pathSeparator);
		String[] pathParts = com.cy.generator.util.StringHelper.tokenizeToStringArray(path, this.pathSeparator);
	...
	public String combine(String pattern1, String pattern2) {
		if (com.cy.generator.util.StringHelper.isBlank(pattern1) && com.cy.generator.util.StringHelper.isBlank(pattern2)) {
			return "";
		}
		else if (com.cy.generator.util.StringHelper.isBlank(pattern1)) {
			return pattern2;
		}
		else if (com.cy.generator.util.StringHelper.isBlank(pattern2)) {
			return pattern1;
		}
	...
	private static class AntPatternComparator implements Comparator<String> {
		...
		public int compare(String pattern1, String pattern2) {
			...
			int wildCardCount1 = com.cy.generator.util.StringHelper.countOccurrencesOf(pattern1, "*");
			int wildCardCount2 = com.cy.generator.util.StringHelper.countOccurrencesOf(pattern2, "*");
			...
			int bracketCount1 = com.cy.generator.util.StringHelper.countOccurrencesOf(pattern1, "{");
